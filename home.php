...
<body>
    ...
    <?php if (isset($_SESSION['alertMessage']) && $_SESSION['alertMessage'] !== ''): ?>
        <script type="text/javascript">
            alert("<?php echo addslashes($_SESSION['alertMessage']); ?>");
        </script>
        <?php unset($_SESSION['alertMessage']); // Clear the message after displaying it ?>
    <?php endif; ?>
    <!-- End of Alert Modal for messages -->
    ...
    <header class="sticky-top">
        ...
        <div class="icons">
            ...
            <a href="#registermodal" data-bs-toggle="modal" data-bs-target="#registerModal"><ion-icon name="person-circle"></ion-icon></a>
        </div>
     </header>
          ...
          <div class="modal-content">
            <div class="modal-body">
                ...
                <form action="change_password.php" method="POST" class="p-3 rounded" style="background-color: rgb(18, 18, 81); color: rgb(213, 202, 202); height: 460px; width: 400px;">
                    ...
                    <p>New password will be sent to your Email.</p>
                    <form-group>
                        <label for="email">Email Id*</label>
                        <input type="email" name="email" class="form-control" placeholder="Email" required>
                    </form-group>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body">
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                <form action="forgot.php" method="POST" class="p-3 rounded" style="background-color: rgb(18, 18, 81); color: rgb(213, 202, 202); height: 350px; width: 400px;">
                    <h1>Forgot Password</h1>
                    <p>A default password will be sent to your email.</p>
                    <div class="form-group mb-3">
                        <label for="email">Email ID*</label>
                        <input type="email" name="email" class="form-control" placeholder="Enter your email" required>
                    </div>
                    <button type="submit" class="btn btn-primary my-4 w-100">Send Default Password</button>
                    <a class="form-control text-primary" style="background:none; border: none; padding-left: 140px;" href="#" data-bs-toggle="modal" data-bs-target="#loginModal">Login Now!</a>
                </form>                
            </div>
        </div>
    </div>
